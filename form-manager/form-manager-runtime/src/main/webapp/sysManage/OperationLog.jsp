	...
	<body class="hold-transition skin-blue sidebar-mini base_skin-aqua">
								...
								<table id="dataTable" class="box base_tablewrap" data-toggle="table" data-locale="zh-CN"
									...
									<thead style="text-align:center;">
										<tr>
											...
											<th data-field="businessCode">业务编号</th>
											<!-- <th data-field="userId">用户ID</th> -->
											<th data-field="userName" >系统用户名</th>
											<!-- <th data-field="serviceId">业务账号</th> -->
											<th data-field="serviceName">业务账号</th>
											<th data-field="accessTime" data-formatter="formatDate">访问时间</th>
											<th data-field="seal" >公章名称</th>
											<th data-field="accessIp" >访问地址</th>
											<th data-field="itemCode" >事项编号</th>
											<th data-field="cerNo" >被查身份证号</th>
											<th data-field="status" data-formatter="formatStatus">访问状态</th>
											<th data-field="memo" >访问情况备注</th>
										</tr>
									</thead>
								</table>
							</div>
		...
		<script type="text/javascript">
			...
			function ajaxRequest(params) {
				...
				$.ajax({
					type : 'post',
					url : 'accessLogAction!findOperationLogPage.action',
					data:dataStr,
					dataType : 'json',
					cache : false,
					async : true,
