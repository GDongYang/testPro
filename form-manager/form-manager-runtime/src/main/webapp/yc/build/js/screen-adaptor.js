...
(function() {
    ...
    if ($setting) {
        ...
        var nPxUt = content.match(/nPxUnit=([\d\.]+)/);
    ...
    var fAdapt = function() {
        ...
        var winWid = window.screen.availWidth //oRect.width;
        var winHei = window.screen.availHeight //oRect.height;
        var ratio = (winHei / winWid) < (nDesignHei / nDesignWid) ? (winHei / nDesignHei) : (winWid / nDesignWid);
        ratio = bNoScroll ? ratio : (winWid / nDesignWid);
        $html.style.fontSize = (ratio * nPxUnit * dpr) + 'px';
    }
