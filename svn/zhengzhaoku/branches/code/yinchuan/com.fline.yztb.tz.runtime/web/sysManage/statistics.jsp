								...
								<div class="row">
									...
									<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
										...
										<div class="row">
											...
											<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 base_query-group">
												<label class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-right base_input-title base_text-size-15" for="itemCreateType">事项类型</label>
...
// 				initDataTable();
			...
			function getParams(){
				...
				var itemType=$("#itemCreateType").val();
				var params={
					'certcode':certCode,
					'itemcode':itemCode,
