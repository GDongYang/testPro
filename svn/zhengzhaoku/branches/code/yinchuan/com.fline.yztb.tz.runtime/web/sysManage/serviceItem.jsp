				...
				<section class="content">
					...
					<div name="boxSkin" class="box base_box-area-aqua" >
						<div class="box-header with-border base_box-header">
							<h3 class="box-title">
								<i class="fa fa-tag"></i> <span class="base_text-size-15">服务事项管理</span>
							</h3>
		...
		<script type="text/javascript">
			...
			function expandRow(event,index,row){
				...
				$submit.click(function(){
					...
					$.ajax({
						cache : true,
						type : "POST",
						url : 'serviceItemAction!updateAssociatedCerts.action', 
						dataType : 'json',
						data : param,
			...
			function formatPosition(value,row,index){
				...
				$.ajax({
					cache : true,
					type : "POST",
					url : 'serviceItemAction!findPositionName.action',
					dataType : 'json',
					data : {
						id : row.id
					},
			...
			function ajaxRequest(params) {
				...
				$.ajax({
					type : 'post',
					url : 'serviceItemAction!findPageTable.action?pageNum=' + pageNum
							+ '&pageSize=' + pageSize,
					dataType : 'json',
					cache : false,
					async : true,
...
// 							}
			...
			function findRPosition(itemId){
				$.ajax({
					cache : true,
					type : "POST",
					url : 'serviceItemAction!findPositionId.action',
					dataType : 'json',
					data : {
						id : itemId
					},
			...
			function findRTemp(itemMemo){
				...
				$.ajax({
					cache : true,
					type : "POST",
					url : 'serviceItemAction!findRTemp.action',
					dataType : 'json',
					data : {
						memo : itemMemo
					},
