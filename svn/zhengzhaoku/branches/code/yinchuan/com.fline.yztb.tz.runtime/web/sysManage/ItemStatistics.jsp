				...
				<section class="content">
					...
					<div name="boxSkin" class="box base_box-area-aqua">
						<div class="box-header with-border base_box-header">
							<h3 class="box-title"><i class="fa fa-tag"></i> <span class="base_text-size-15">事项统计</span></h3>
								...
								<table id="dataTable" class="box base_tablewrap" data-toggle="table" data-locale="zh-CN"
									...
									<thead style="text-align:center;">
										<tr>
											...
											<!-- <th data-field="askDate" data-formatter="formatDate">日期</th> -->
...
// 				initDataTable();
			...
			function ajaxRequest(params) {
				...
				$.ajax({
					type : 'post',
					url : 'businessAction!findItemCount.action?pageNum=' + pageNum +'&pageSize='+pageSize,
					dataType : 'json',
					cache : false,
					async : true,
					data : param,
