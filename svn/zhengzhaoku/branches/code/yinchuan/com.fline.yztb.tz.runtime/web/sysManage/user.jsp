...
<html lang="en">
	...
	<body class="hold-transition skin-blue sidebar-mini base_skin-aqua">
		...
		<!-- 						<button type="button" class="btn btn-xs btn-info" onClick="passReset()">密码重置</button>
								...
								<button type="button" class="btn btn-xs btn-info" onClick="testDing()">绑定钉钉</button>								
<!-- 								<button type="button" class="btn btn-xs btn-info" onClick="testDing()">测试</button>	 -->							
								...
								<table id="tablewrap" class="box base_tablewrap" data-toggle="table" data-locale="zh-CN"
									...
									<thead style="text-align:center;">
										...
										<!-- 	<th data-field="sex" data-formatter="formatSex">性别</th> -->
											...
											<th data-field="nCount" data-formatter="formatRCount">是否绑定钉钉</th>
										</tr>
									</thead>
								</table>
							</div>
	...
	<!--  钉钉表单-->
		<div id="dataNotice" class="base_hidden">
			<form class="form-horizontal base_dialog-form" id="dataform1" name="dataform1">
				<div style="display:none" id="hiddenDiv">
				</div>
				<!-- /.base_query-group -->
				<div class="col-xs-12 col-sm-10 col-md-10 col-lg-10 base_query-group" id="userNameDiv">
					<label class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-right base_input-title base_text-size-15" >手机号</label>
					<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 base_input-area">
						<input type="text" class="form-control base_input-text" id="mobile" name="mobile" placeholder="手机号" />
						<button type="button" class="btn btn-xs btn-info" onClick="findByMobile()">读取</button>
					</div>
				</div>
				<div class="col-xs-12 col-sm-10 col-md-10 col-lg-10 base_query-group">
					<label class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-right base_input-title base_text-size-15" >钉钉userid</label>
					<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 base_input-area">
						<input type="text" class="form-control base_input-text" id="userId" name="userId" placeholder="钉钉userid" readonly="readonly"/>
					</div>
				</div>
