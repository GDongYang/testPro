                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <select class="form-control chosen-select-deselect"
                                            chosen-position="true" name="status" id="status">
                                        <option
                                                value="4" selected=selected>请选择
                                        </option>
                ...
                <div class="box-header with-border base_box-header">
                    ...
                    <div class="box-tools pull-right">
                        <button type="button" class="btn btn-xs btn-info"
                                onClick="doSignByActiveX()">本地Ukey盖章
                        </button>
                        <button type="button" class="btn btn-xs btn-info"
...
<script type="text/javascript">
    ...
    function uploadCurrentFileToServer(id, filePath) {
        ...
        var Res = TGPDFPlugIn.UploadFileToServer(basePath + "/sealUncoveredAction!complete.action", filePath, 'file', extraParam);
    }
