		...
		<section class="content">
			...
			<div class="base_query-area">
				<form class="form form-inline" id="searchForm">
					<label class="base_text-size-15">被查询人姓名：</label>
					<input type="text" id="sfName" name="sfName" placeholder="被查询人姓名" class="form-control" readonly="readonly" style="width: 100px"/>
					<label class="base_text-size-15">被查询人身份证号：</label>
					<input type="text" id="sfId" name="sfId" placeholder="被查询人身份证号" class="form-control" readonly="readonly" style="width: 150px"/>
					<label class="base_text-size-15">商品房合同编号：</label>
					<input type="text" id="HTBH" name="HTBH" placeholder="商品房合同编号" class="form-control"  style="width: 150px"/>
					<label class="base_text-size-15">所在城市：</label>
					<select class="form-control" id="szcs" name="szcs">
						...
						<option value="台州市" selected>台州市</option>
...
<script type="text/javascript">
    ...
    function stateFormatter(val,row) {
		if(row.certData == null||row.certData.length==0) {
            return row.errorMsg;
        } else {
            return "成功";
        }
    ...
    function ajaxRequest(params) {
        ...
        $.ajax({
            type : 'post',
            url : '<%=path%>/tempInfoAction!findSpFHt.action',
            dataType : 'json',
            cache : false,
            async : true,
            data : param,
    ...
    function details(val,row){
        if(row !=null && row.certData != null&&row.certData.length!=0){
