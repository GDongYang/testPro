	...
	<body class="hold-transition skin-blue sidebar-mini base_skin-aqua">
								...
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
										<div class="row">
											...
											<!-- /.base_query-group -->
											<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 base_query-group" style="padding-top:5px;">
											    <label class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-right base_input-title base_text-size-15">新生儿姓名</label>
												<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 base_input-area">
													<input type="text" class="form-control base_input-text" id="childName" name="childName" placeholder="新生儿姓名" />
												</div>
											</div>
											<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 base_query-group" style="padding-top:5px;">
		...
		<script type="text/javascript">
			...
			function ajaxRequest(params) {
				...
				$.ajax({
					type : 'post',
					url : '<%=path%>/tempInfoAction!findBirthInfo.action', 
					dataType : 'json',
					cache : false,
					async : true,
					data : param,
			...
			function search() {
				...
				if($("#childName").val() == null || $("#childName").val() == "") {
					Modal.alert({ msg:"请输入新生儿姓名！", title:'提示', btnok:'确定' });
					return false;
				}
				cerNo = $("#sfId").val();
				sfName = $("#sfName").val();
