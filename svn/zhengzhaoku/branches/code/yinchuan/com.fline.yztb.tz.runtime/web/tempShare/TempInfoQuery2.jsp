	...
	<body class="hold-transition skin-blue sidebar-mini base_skin-aqua">
								...
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-right">
										<div class="form-group text-right base_options-area">
										    <button type="button" id="readCardBtn" class="btn btn-sm btn-info" onClick="readCard()" style="width:180px;font-size:18px;">可信身份认证</button>
										</div>
									</div>
		...
		<script type="text/javascript">
			...
			function readCard(){
				...
				if($("#sfId").val() == "" || $("#sfName").val() == "") {
                    Modal.alert({ msg:"请填写姓名和身份证！", title:'提示', btnok:'确定' });
                    return false;
                }
