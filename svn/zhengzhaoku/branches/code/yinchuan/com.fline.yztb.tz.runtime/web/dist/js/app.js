...
$(function () {
 ...
 $.AdminLTE.layout.activate();
  ...
  //设置侧边栏默认显示形式
  if ($('.navigationTag').length > 0) {
	$('.navigationTag').each(function () {
  ...
  fixSidebar: function () {
    ...
    if (!$("body").hasClass("fixed")) {
      if (typeof $.fn.slimScroll != 'undefined') {
        $(".sidebar").slimScroll({destroy: true}).height("auto").width("none");
      }
      return;
...
$.AdminLTE.pushMenu = function (toggleBtn) {
  ...
  $(toggleBtn).click(function (e) {
    ...
    if ($(".wrapper").width() > (screenSizes.sm - 1)) {
    	$("body").toggleClass('sidebar-collapse');
    	var w = $(".navigationSidebar").width();
    	var mainW = $(".wrapper").width();
    	var contentW = $(".base_iframe-content-wrapper").width();
		if (mainW > contentW) {
			$(".navigationSidebar").css({"left":0 - w + "px"});
			$(".base_iframe-content-wrapper").css({"margin-left":"0px"});
		} else {
			$(".navigationSidebar").css({"left":"auto"});
			$(".base_iframe-content-wrapper").css({"margin-left":w + "px"});
		}
    }
  ...
  $(".content-wrapper").click(function () {
    ...
    if ($(window).width() <= (screenSizes.sm - 1) && $("body").hasClass("sidebar-open")) {
      ...
      alert(3);
      if (isBrowser().ie) {
      	$(".navigationSidebar").css({"left":"0px"});
      }
    }
  });
  ...
  $("li a", $(menu)).click(function (e) {
    ...
    //If the menu is not visible
      ...
      checkElement.slideDown('normal', function () {
    	...
    	//console.log(checkElement,checkElement.hasClass('treeview-menu'));
        checkElement.addClass('menu-open');
        if(checkElement.hasClass('treeview')||checkElement.hasClass('treeview-menu')){
    ...
    if (checkElement.is('.treeview-menu')) {
    	...
    	var parent = $this.parents('ul').first();
    	if(checkElement.hasClass('treeview')){
        	parent.find('li.treeview.active').removeClass('active');
        }
        else {
