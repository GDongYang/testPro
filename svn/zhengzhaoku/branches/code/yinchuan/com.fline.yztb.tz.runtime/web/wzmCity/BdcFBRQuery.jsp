		...
		<section class="content">
			...
			<div class="base_query-area">
				<form class="form form-inline" id="searchForm">
					...
					<input type="text" id="otherCerName" name="otherCerName" placeholder="办事人姓名" class="form-control" readonly="readonly" style="width: 100px"/>
					<label class="base_text-size-15">办事人身份证号：</label>
					<input type="text" id="otherCerNo" name="otherCerNo" placeholder="办事人身份证号" class="form-control" readonly="readonly" style="width: 150px"/>
					<label class="base_text-size-15">不动产所属人姓名：</label>
					<input type="text" id="sfName" name="sfName" placeholder="被查询人姓名" class="form-control" style="width: 100px"/>
					<label class="base_text-size-15">不动产所属人身份证号：</label>
					<input type="text" id="sfId" name="sfId" placeholder="被查询人身份证号" class="form-control" style="width: 150px"/>
					<br/><label class="base_text-size-15 base_margin-t-10">事项：</label>
					<select class="form-control base_margin-t-10" id="itemCode" name="itemCode"></select>
...
<script type="text/javascript">
    ...
    function ajaxRequest(params) {
        ...
        $.ajax({
            type : 'post',
            url : '<%=path%>/tempInfoAction!findByBdcFbr.action',
            dataType : 'json',
            cache : false,
            async : true,
            data : param,
