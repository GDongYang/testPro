...
<head>
	...
	<jsp:include page="../css/PageletCSS.jsp" >
		<jsp:param value="table,icheck,date,icon,chosen" name="p"/>
	</jsp:include>
</head>
		...
		<section class="content">
			...
			<div class="base_query-area">
				<form class="form form-inline" id="searchForm">
							<div class="row">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<label class="base_text-size-15">办事人姓名：</label> 
							<input type="text" id="otherCerName" name="otherCerName"
								placeholder="办事人姓名" class="form-control base_input-text" readonly="readonly"
								style="width: 100px" /> 
							<label class="base_text-size-15">办事人身份证号：</label>
							<input type="text" id="otherCerNo" name="otherCerNo"
								placeholder="办事人身份证号" class="form-control base_input-text" readonly="readonly"
								style="width: 150px" /> 
							<label class="base_text-size-15">事项：</label>
							<select class="form-control" id="itemCode" name="itemCode"></select>
							</div>
						<div class="pull-right">
							<button type="button" id="readCardBtn"
								class="btn btn-sm btn-info" onClick="readCard()"
								style="line-height: 30px; padding: 0px 10px; font-size: 18px;">身份证读取</button>
						</div>
						<div class="row">
							<div
								class="col-xs-12 col-sm-5 col-md-5 col-lg-5 base_query-group"
								style="padding-top: 5px;">
								<label
									class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-right base_input-title base_text-size-15">统一社会信用代码</label>
								<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 base_input-area">
									<input type="text" class="form-control base_input-text"
										id="uniscId" name="uniscId" placeholder="统一社会信用代码（查询企业社保信息输入税号）" />
								</div>
							</div>
							<div
								class="col-xs-12 col-sm-5 col-md-5 col-lg-5 base_query-group"
								style="padding-top: 5px;">
								<label
									class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-right base_input-title base_text-size-15">企业名称</label>
								<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 base_input-area">
									<input type="text" class="form-control base_input-text"
										id="entName" name="entName" placeholder="企业名称" />
								</div>
							</div>
							<!-- /.base_query-group -->
						</div>
						<div class="col-xs-12 col-sm-5 col-md-5 col-lg-5 base_query-group"
							style="padding-top: 5px;">
							<label
								class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-right base_input-title base_text-size-15"
								for="altDate">变更日期</label>
							<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 base_input-area">
								<div class="input-group base_input-group">
									<input type="text"
										class="form-control pull-left base_input-groupright-area"
										id="altDate" name='altDate'
										data-date-format="yyyy-mm-dd" placeholder="(企业变更信息专用)" />
								</div>
							</div>
						</div>
						<div
							...
							style="padding-top: 5px;">
							<label
								class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-right base_input-title base_text-size-15">企业类型</label>
							<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 base_input-area">
									　<input type="radio" name="entType" id="entType" value="1"  checked />个体户
									　<input type="radio" name="entType" id="entType" value="2"   />企业
							</div>
						</div>
					</form>
...
/*      function initDatepicker(){
    ...
    function ajaxRequest(params) {
        ...
        $.ajax({
            type : 'post',
            url : '<%=path%>/tempInfoAction!findQY.action',
            dataType : 'json',
            cache : false,
            async : true,
            data : param,
    ...
    function readCard(){
        ...
        if($("#uniscId").val() == null || $("#sfid").val() == "") {
            Modal.alert({ msg:"请输入企业信用代码！", title:'提示', btnok:'确定' });
            return false;
        }
